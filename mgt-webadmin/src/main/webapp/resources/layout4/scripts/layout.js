        ...
        var menus = [
            ...
            },
            {
                ...
                "subList": [
                    ...
                    {"name": "用户导入", "icon": "huiyuan", "url": "securityUserImportList"},
                    ...
                    {"name": "系统参数", "icon": "luru", "url": "commonMapMgt"},
                    {"name": "渠道映射", "icon": "luru", "url": "mediaMappingMgt"},
                    {"name": "批处理", "icon": "luru", "url": "batchMgt"}
                ]},
            {
                "name": "订单查询", "icon": "huiyuan","url": "commonOrder"
            },{
                "name": "话单查询", "icon": "huiyuan","url": "callOrder"
            },{
                "name": "车商汇订单", "icon": "huiyuan","url": "cshOrderMgt"
            },{
                "name": "车商汇话单", "icon": "huiyuan","url": "cshCallMgt"
            },{
                "name": "订单数据转换", "icon": "huiyuan","url": "orderTransMgt"
            },{
                "name": "项目活动管理", "icon": "huiyuan","url": "projectMgt"
            },{
                "name": "经销商管理", "icon": "huiyuan","url": "dealerMgt"
            }
        ];
